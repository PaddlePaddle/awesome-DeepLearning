...
def read_data_bananas(is_train=True):
    ...
    for img_name, target in csv_data.iterrows():
        transfrom = paddle.vision.transforms.Transpose(order=(2, 0, 1))
        images.append(d2l.tensor(transfrom(image_load(os.path.join(data_dir, 'bananas_train' if is_train else
