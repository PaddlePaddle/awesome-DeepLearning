...
```
    ...
    W0225 11:21:27.203183   134 device_context.cc:447] Please NOTE: device: 0, GPU Compute Capability: 7.0, Driver API Version: 11.0, Runtime API Version: 10.1
    W0225 11:21:27.209620   134 device_context.cc:465] device: 0, cuDNN Version: 7.6.
...
def init_weights(m):
    if type(m) in (nn.Linear, nn.Conv1D):
         paddle.framework.ParamAttr(initializer=paddle.nn.initializer.XavierUniform())
...
```
    ...
    loss 0.193, train acc 0.928, test acc 0.866
    2292.9 examples/sec on [CUDAPlace(0)]




![svg](../img/output_cnn_nlp.svg)
