    ...
    <div class="login">
        <div class="content">
            <div class="box">
                ...
                <form method="post" id="form-email" action="/login;jsessionid=eb172258a75341cd8161730430f34b37">
                    <div class="email-area">
                        ...
                        <input type="hidden" name="lt" id="lt-email" value="LT-631912686671106048-q7NEU">
                ...
                <form method="post" id="form-token" action="/login;jsessionid=eb172258a75341cd8161730430f34b37">
                    <div class="token-area">
                        ...
                        <input type="hidden" name="rememberMe" value="on">
                        <input type="hidden" name="lt" id="lt-token" value="LT-631912686671106048-q7NEU">
                ...
                <form method="post" id="formQRCode" action="/login;jsessionid=eb172258a75341cd8161730430f34b37">
                    <div class="qcode-area">
                        ...
                        <input type="hidden" name="rememberMe" value="on">
                        <input type="hidden" name="lt" id="lt-qrCode" value="LT-631912686671106048-q7NEU">
...
<script type="text/javascript"
        src="/beep-sdk.js?language=zh&amp;v=1628589324876"></script>
