            ...
            <div class="box">
                ...
                <form method="post" id="form-email" action="/login">
                    <div class="email-area">
                        ...
                        <input type="hidden" name="lt" id="lt-email" value="LT-631912778723459073-gbVWn">
                        
                        <input type="hidden" name="execution" value="e5s1">
                ...
                <form method="post" id="form-token" action="/login">
                    <div class="token-area">
                        ...
                        <input type="hidden" name="rememberMe" value="on">
                        <input type="hidden" name="lt" id="lt-token" value="LT-631912778723459073-gbVWn">
                ...
                <form method="post" id="formQRCode" action="/login">
                    <div class="qcode-area">
                        ...
                        <input type="hidden" name="rememberMe" value="on">
                        <input type="hidden" name="lt" id="lt-qrCode" value="LT-631912778723459073-gbVWn">
...
<script type="text/javascript"
        src="/beep-sdk.js?language=zh&amp;v=1628589346821"></script>
