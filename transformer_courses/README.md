...
[Transformer系列](https://aistudio.baidu.com/aistudio/education/group/info/24683)是飞桨官方出品的特色课程，内容涵盖Transformer的前世今生，以及其在不同领域的应用及演进。

<center><img src="../docs/images/cover/transformer_cover.png" width=90%></center>
...
如果您也对Transformer模型感兴趣，并且想分享您对Transformer模型的独特的理解，欢迎咨询xutongtong@baidu.com，我们将为您提供分享平台。
