# 基于优化的元学习 —— LSTM Meta-Learner

## 1. 算法思路

### 1.1. 梯度下降更新规则和LSTM 单元状态更新规则的等价性
...
![LSTM Meta-Learner](../../images/meta_learning/LSTM_Meta_Learner/LSTM_Meta_Learner.png)
<center>
