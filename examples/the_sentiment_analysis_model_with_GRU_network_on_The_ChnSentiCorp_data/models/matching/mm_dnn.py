...
class MMDNN(object):
    ...
    def conv_pool_relu_layer(self, input, mask=None):
        ...
        if mask is not None:
            cross_mask = fluid.layers.stack(
                x=[mask] * self.kernel_size, axis=1)
    ...
    def predict(self, left, right):
        ...
        if self.match_mask:
            ...
            cross_mask = None
        conv_pool_relu = self.conv_pool_relu_layer(
            input=cross, mask=cross_mask)
