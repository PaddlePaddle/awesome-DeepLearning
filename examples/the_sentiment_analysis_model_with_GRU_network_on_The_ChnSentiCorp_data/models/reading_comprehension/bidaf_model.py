...
def point_network_decoder(p_vec, q_vec, hidden_size, args):
    ...
    def custom_dynamic_rnn(p_vec, init_state, hidden_size, para_name, args):
        ...
        def static_rnn(step,
            ...
            for i in range(step):
                ...
                attn_ctx = layers.sequence_pool(
                    input=attn_ctx, pool_type='sum')
    ...
    fw_outputs = custom_dynamic_rnn(p_vec, init_state, hidden_size,
                                    tag + "fw_", args)
    bw_outputs = custom_dynamic_rnn(p_vec, init_state, hidden_size,
                                    tag + "bw_", args)
