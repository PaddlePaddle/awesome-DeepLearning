...
<center><img src="https://ai-studio-static-online.cdn.bcebos.com/517260aee7f24b97bb8e42774daf1b4ee5aaa5824d004ed1854a04bde4a1c8ac" width="700" style="zoom:80%" ></center>
...
```
    ...
    8745950 tokens in the corpus
    [5233, 3080, 3133, 155, 741, 10571, 27349, 102, 15067, 58112, 854, 3580, 4, 10712, 214, 1324, 104, 454, 2731, 362, 3672, 708, 371, 36, 539, 11, 1423, 2757, 686, 7088, 247, 5233, 10, 1052, 0, 248, 44611, 2877, 792, 186, 5233, 602, 1134, 2621, 8983, 279, 4147, 141, 6437, 4186]
...
```
    ...
    center_word originated, target leveller, label 0
    center_word originated, target weisman, label 0
    center_word originated, target mediterraneus, label 0
    center_word originated, target markhasev, label 0
    center_word abuse, target anarchism, label 1
    center_word abuse, target verzeichnis, label 0
    center_word abuse, target saturnine, label 0
    center_word abuse, target remington, label 0
    center_word abuse, target casse, label 0
    center_word anarchism, target abuse, label 1
    center_word anarchism, target skrayling, label 0
    center_word anarchism, target waterdown, label 0
    center_word anarchism, target climatology, label 0
    center_word anarchism, target electrodynamic, label 0
    center_word originated, target abuse, label 1
    center_word originated, target cardini, label 0
    center_word originated, target demjanuk, label 0
    center_word originated, target dhcpv, label 0
    center_word originated, target dribbled, label 0
    center_word against, target abuse, label 1
    center_word against, target plovdiv, label 0
    center_word against, target berridge, label 0
    center_word against, target soysa, label 0
    center_word against, target tohoku, label 0
    center_word working, target abuse, label 1
    center_word working, target mehra, label 0
    center_word working, target haslingden, label 0
    center_word working, target kirchoff, label 0
    center_word working, target mahl, label 0
    center_word radicals, target abuse, label 1
    center_word radicals, target conservitive, label 0
    center_word radicals, target bredow, label 0
    center_word radicals, target tiebout, label 0
    center_word radicals, target electrically, label 0
    center_word working, target radicals, label 1
    center_word working, target cyberlink, label 0
    center_word working, target agathonike, label 0
    center_word working, target ultor, label 0
    center_word working, target relentless, label 0
    center_word diggers, target radicals, label 1
    center_word diggers, target gokoro, label 0
    center_word diggers, target jump, label 0
    center_word diggers, target ancient, label 0
    center_word diggers, target bollor, label 0
    center_word against, target diggers, label 1
    center_word against, target hudspeth, label 0
    center_word against, target tabant, label 0
    center_word against, target hephestus, label 0
    center_word against, target hyrax, label 0
