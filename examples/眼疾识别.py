...
DATADIR = '/home/aistudio/PALM-Training400'
...
get_ipython().system('unzip /home/aistudio/PALM-Training400/PALM-Training400.zip -d training/')
...
data_xls = pd.read_excel('PALM-Validation-GT/PM_Label_and_Fovea_Location.xlsx', index_col=0)
data_xls.to_csv('PALM-Validation-GT/PM_Label_and_Fovea_Location.csv', encoding='utf-8')
...
datadir = 'training/PALM-Training400'
filenames = os.listdir(datadir)
num = 0
for name in filenames:
    if name != 'None':
...
# 定义训练过程
def train(model,DATADIR,DATADIR2,CSVFILE):
    use_gpu = True
