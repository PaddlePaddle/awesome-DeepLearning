...
#解压数据
get_ipython().system('unzip -o -q -d /home/aistudio/work/palm /home/aistudio/data/data90836/training.zip')
get_ipython().run_line_magic('cd', '/home/aistudio/work/palm/PALM-Training400/')
get_ipython().system('unzip -o -q PALM-Training400.zip')
get_ipython().system('unzip -o -q -d /home/aistudio/work/palm /home/aistudio/data/data90836/validation.zip')
get_ipython().system('unzip -o -q -d /home/aistudio/work/palm /home/aistudio/data/data90836/valid_gt.zip')
